...
[SPSS:n käytön oppimiseen]{.underline} suosittelen psykologi Andy Fieldin erinomaista teosta *Discovering Statistics with IBM SPSS Statistics*. Teoksesta löytyy viisi julkaistua versiota, sekä [tukiverkkosivu](#0).
...
[Pythonille löytyy oma "akateeminen" julkaisupaketti]{.underline} nimeltä [Anaconda](#0). Paketti sisältää kaikki tilastolliselle työskentelylle vaaditut paketit, sekä ohjelmistoja, jotka auttavat koodin kirjoittamisessa ja testaamisessa.
