...
[Kovarianssin käyttö on jokseenkin hankalaa]{.underline}, koska mittayksiköt eivät ole standardisoituja eivätkä usein tarkoita mitään todellista. Tämän takia kovarianssi standardisoidaan, jolloin saadaan **Pearsonin korrelaatiokertoin** $r$.
...
Jakolaskun yläpuolella: kerro korrelaatiokertoin otoskoon minus kaksi neliöjuurella. Jakolaskun alapuolella: ota korrelaatiokertoimen neliö, vähennä se yhdestä, ja ota tuloksen neliöjuuri.
...
**Z-arvon laskukaava** on hieman hankala. Laske ensin korrelaatiokertoin plus yksi sekä korrelaatiokertoin minus yksi, ja jaa ensimmäinen toisella. Ota sitten tuloksen luonnollinen logaritmi. Viimeiseksi, kerro tulos puolella, eli 0,5.
