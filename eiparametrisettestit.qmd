...
**Wilcoxonin signed-rank-testi** (myös Wilcoxonin rankitesti parivertailulle[^eiparametrisettestit-2], tai vain Wilcoxonin testi[^eiparametrisettestit-3]) on ei-parametrinen vastine **parillisen otoksen t-testille**. Testillä testataan, eroavatko kaksi muuttujaa toisistaan merkitsevästi.
